...
public class SwapTwoStrings {
	public static void main(String[] args) {
		...
		private static Container swapStrings(Container container) {
			container.setFirstString(container.getFirstString().concat(container.getSecondString()));
			container.setSecondString(container.getFirstString().substring(0, container.getFirstString().length() - container.getSecondString().length()));
